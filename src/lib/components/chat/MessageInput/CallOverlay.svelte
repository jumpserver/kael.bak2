				...
				{:else}
					<div
						class=" {rmsLevel * 100 > 4
							...
							?.profile_image_url ?? '/kael/static/favicon.png') !== '/kael/static/favicon.png'
							? ' bg-cover bg-center bg-no-repeat'
							: 'bg-black dark:bg-white'}  bg-black dark:bg-white"
						style={(model?.info?.meta?.profile_image_url ?? '/kael/static/favicon.png') !==
						'/kael/static/favicon.png'
